            ...
            <ListItemText
              primary={
                <Typography variant="body1" sx={{ textAlign: "left" }}>
                  ...
                  ΔT: {entry.deltaT}K | Área Total: {entry.totalArea} m² | Resistência: {Number(entry.totalResistance).toFixed(6)} K/W | Fluxo: {entry.heatFlux} W
                ...
                <Box sx={{ textAlign: "left" }}>
                  ...
                  <ul style={{ paddingLeft: "16px", margin: 0 }}>
                    {entry.layers.map((layer, i) => (
                      <li key={i}>
                        🔹 <strong>h:</strong> {layer.h || "N/A"} W/m²K | Área: {layer.a || "N/A"} m²
                      </li>
                    ))}
                  </ul>
                </Box>
